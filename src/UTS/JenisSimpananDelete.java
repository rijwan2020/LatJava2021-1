...
class jenisSimpananDeleteFrame extends JInternalFrame implements ActionListener {
    ...
    jenisSimpananDeleteFrame(){
        /* membuat label pada window border */
        super("Hapus Data Jenis Simpanan",true,true,true,true);
    ...
    public void actionPerformed(ActionEvent event){
        ...
        if (event.getSource()==b_delete) {
            try{
                ...
                String sql="delete from jenis where kode = '"+kode+"'";
                statement.execute(sql);
                //statement.close();
                //connection.close();
                JOptionPane.showMessageDialog(this,"Data jenis simpanan berhasil dihapus.");
                t_cari.setText("");
                t_kode.setText("");
                t_nama.setText("");
            } catch(Exception e){
        ...
        if (event.getSource()==b_cari) {
            try{
                ...
                if(rs.next()){
                    ...
                    JOptionPane.showMessageDialog(this,"Data jenis simpanan tidak ditemukan.");
                }
                //statement.close();
                //connection.close();
            }catch(Exception e){
 ...
 */
public class JenisSimpananDelete{
    public static void main(String args[]) {
        /* memanggil & menjalankan program window diatas */
        new jenisSimpananDeleteFrame();
    }
}
